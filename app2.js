var milad = document.createElement('div');
 ...
 milad.style.cssText = "display:none;top: -1.0vw;letter-spacing: 0.05vw;position: absolute;padding: 0 0.2vw;transition:0.3s;background: rgba(96, 125, 139, 0.5);font-size: 0.6vw;border-radius: 0.2vw 0.2vw 0.2vw 0.2vw;color: #fff;right: 2vw;"
 document.getElementById('player-header').appendChild(milad);
